...
const useUiHelpers = () => {
  ...
  const getFacetsFromURL = () => {
	...
	console.log('rootCatSlug',params.slug_1);
	console.log('getFiltersDataFromUrl(query, true)',getFiltersDataFromUrl(query, true));
	console.log(' query.phrase', query.phrase);
