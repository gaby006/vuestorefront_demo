...
export default {
  ...
  setup(props, context) {
	...
	const productsExtracted=facetGetters.getProducts(result.value);
	console.log('Products: ',productsExtracted);
	return productsExtracted;
	});
    const categoryTree = computed(() => {
	const categories=facetGetters.getCategoryTree(result.value);
